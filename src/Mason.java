...
public class Mason {
    ...
    Mason (SFG givenGraph) {
        graph = givenGraph;
        allNonTouchedLoops = new ArrayList<>();
        allNonTouchedLoopsGain = new ArrayList<>();
    }

    public double calculateDelta(List<Node> nodes, List<List<Node>> cycles, List<Integer> cyclesValue)  {
    ...
    private double calculateithDelta(List<Node> forwardPath, List<List<Node>> cycles, List<Integer>cyclesValue) {
